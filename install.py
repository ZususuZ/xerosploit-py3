...
""")
	...
	if system0 == "1":
		...
		install = os.system("apt-get update && apt-get install -y nmap hping3 build-essential python-pip ruby-dev git libpcap-dev libgmp3-dev && pip3 install tabulate terminaltables")
		...
		install2 = os.system("cd /opt/xerosploit/ && cp xerosploit.py xerosp.py && export PATH=$PATH:/opt/xerosploit/xeros.py")<	
	elif system0 == "2":
		print("\033[1;34m\n[++] Installing Xerosploit ... \033[1;m")
